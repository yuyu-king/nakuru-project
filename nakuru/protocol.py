...
from .network import HttpUtil


class CqhttpProtocol:
    baseurl_http: str
    ...
    async def _send_message(self,
                            ...
                            **additional_payload) -> Union[BotMessage, bool]:
        if isinstance(message, list):
            message = ''.join(chain.toString() for chain in message)
        ...
        try:
            result = await HttpUtil.http_post(f"{self.baseurl_http}/{endpoint}", payload, params=self.protocol_params)
        ...
        if result.get("status") == "ok":
            try:
                ...
                logger.error(f"Missing 'data' field in response: {result}")
                return False
        else:
            logger.error(f"Error sending message: {result.get('status')}")
            return False
    ...
    async def send_private_msg(self,
                               ...
                               auto_escape: bool = False) -> Union[BotMessage, bool]:
        additional_payload = {"user_id": user_id, "auto_escape": auto_escape}
        if group_id is not None:
            additional_payload["group_id"] = group_id
        return await self._send_message("send_private_msg", message, **additional_payload)

    async def send_group_message(self,
                                 group_id: int,
                                 message: Union[str, list],
                                 auto_escape: bool = False) -> Union[BotMessage, bool]:
        additional_payload = {"group_id": group_id, "auto_escape": auto_escape}
        return await self._send_message("send_group_msg", message, **additional_payload)
    ...
    #     result = await HttpUtil.http_post(f"{self.baseurl_http}/send_group_forward_msg", {
    #         "group_id": group_id,
    #         "messages": messages
    ...
    #             messages[i] = messages[i].toDict()
    #
    #     result = await HttpUtil.http_post(f"{self.baseurl_http}/send_private_forward_msg", {
    #         "user_id": user_id,
    #         "messages": messages
    #     }, params=self.protocol_params)
    #     if result["status"] == "ok":
    ...
    #     result = await HttpUtil.http_post(f"{self.baseurl_http}/delete_msg", {
    ...
    #     result = await HttpUtil.http_post(f"{self.baseurl_http}/get_msg", {
    #         "message_id": message_id
    #     }, params=self.protocol_params)
    #     if result["status"] == "ok":
    ...
    #     result = await HttpUtil.http_post(f"{self.baseurl_http}/get_forward_msg", {
    #         "message_id": message_id
    #     }, params=self.protocol_params)
    #     if result["status"] == "ok":
    ...
    #     result = await HttpUtil.http_post(f"{self.baseurl_http}/get_image", {
    #         "file": file
    #     }, params=self.protocol_params)
    #     if result["status"] == "ok":
    ...
    #     result = await HttpUtil.http_post(f"{self.baseurl_http}/set_group_kick", {
    #         "group_id": group_id,
    #         "user_id": user_id,
    ...
    #     result = await HttpUtil.http_post(f"{self.baseurl_http}/set_group_ban", {
    #         "group_id": group_id,
    #         "user_id": user_id,
    #         "duration": duration
    #     }, params=self.protocol_params)
    ...
    #     result = await HttpUtil.http_post(f"{self.baseurl_http}/set_group_anonymous_ban", {
    #         "group_id": group_id,
    #         "flag": flag,
    #         "duration": duration
    #     }, params=self.protocol_params)
    ...
    #     result = await HttpUtil.http_post(f"{self.baseurl_http}/set_group_whole_ban", {
    #         "group_id": group_id,
    #         "enable": enable
    #     }, params=self.protocol_params)
    #     if result["status"] == "ok":
    ...
    #                         user_id: int,
    #                         enable: bool = True) -> bool:
    #     result = await HttpUtil.http_post(f"{self.baseurl_http}/set_group_admin", {
    #         "group_id": group_id,
    #         "user_id": user_id,
    #         "enable": enable
    #     }, params=self.protocol_params)
    ...
    #     result = await HttpUtil.http_post(f"{self.baseurl_http}/set_group_anonymous", {
    #         "group_id": group_id,
    #         "enable": enable
    #     }, params=self.protocol_params)
    #     if result["status"] == "ok":
    ...
    #                        user_id: int,
    #                        card: str = "") -> bool:
    #     result = await HttpUtil.http_post(f"{self.baseurl_http}/set_group_card", {
    #         "group_id": group_id,
    #         "user_id": user_id,
    #         "card": card
    #     }, params=self.protocol_params)
    ...
    #                        group_id: int,
    #                        group_name: str) -> bool:
    #     result = await HttpUtil.http_post(f"{self.baseurl_http}/set_group_name", {
    #         "group_id": group_id,
    ...
    #     result = await HttpUtil.http_post(f"{self.baseurl_http}/set_group_leave", {
    #         "group_id": group_id,
    ...
    #                                special_title: str = "",
    #                                duration: int = -1) -> bool:
    #     result = await HttpUtil.http_post(f"{self.baseurl_http}/set_group_special_title", {
    #         "group_id": group_id,
    #         "user_id": user_id,
    ...
    #                            approve: bool = True,
    #                            remark: str = "") -> bool:
    #     result = await HttpUtil.http_post(f"{self.baseurl_http}/set_friend_add_request", {
    #         "flag": flag,
    #         "approve": approve,
    #         "remark": remark
    #     }, params=self.protocol_params)
    ...
    #         return False
    #     result = await HttpUtil.http_post(f"{self.baseurl_http}/set_group_add_request", {
    #         "flag": flag,
    #         "sub_type": sub_type,
    #         "approve": approve,
    #         "reason": reason
    ...
    #     result = await HttpUtil.http_post(f"{self.baseurl_http}/get_login_info", params=self.protocol_params)
    #     if result["status"] == "ok":
    #         return Bot.parse_obj(result["data"])
    #     return False
    #
    # async def getQiDianAccountInfo(self) -> T.Union[QiDianAccount, bool]:
    #     result = await HttpUtil.http_post(f"{self.baseurl_http}/qidian_get_account_info")
    #     if result["status"] == "ok":
    ...
    #     result = await HttpUtil.http_post(f"{self.baseurl_http}/get_stranger_info", {
    #         "user_id": user_id,
    #         "no_cache": no_cache
    #     }, params=self.protocol_params)
    #     if result["status"] == "ok":
    ...
    #     result = await HttpUtil.http_post(f"{self.baseurl_http}/get_friend_list")
    #     if result["status"] == "ok":
    ...
    #                        friend_id: int) -> bool:
    #     result = await HttpUtil.http_post(f"{self.baseurl_http}/delete_friend", {
    #         "friend_id": friend_id
    #     }, params=self.protocol_params)
    #     if result["status"] == "ok":
    #         return True
    ...
    #     result = await HttpUtil.http_post(f"{self.baseurl_http}/get_unidirectional_friend_list")
    #     if result["status"] == "ok":
    #         return [Friend.parse_obj(friend_info) for friend_info in result["data"]]
    #     return False
    #
    ...
    #                                      user_id: int) -> bool:
    #     result = await HttpUtil.http_post(f"{self.baseurl_http}/delete_unidirectional_friend", {
    #         "user_id": user_id
    #     }, params=self.protocol_params)
    #     if result["status"] == "ok":
    #         return True
    ...
    #     result = await HttpUtil.http_post(f"{self.baseurl_http}/get_group_info", {
    #         "group_id": group_id,
    #         "no_cache": no_cache
    #     }, params=self.protocol_params)
    #     if result["status"] == "ok":
    ...
    #     result = await HttpUtil.http_post(f"{self.baseurl_http}/get_group_list")
    #     if result["status"] == "ok":
    ...
    #     result = await HttpUtil.http_post(f"{self.baseurl_http}/get_group_member_info", {
    #         "group_id": group_id,
    #         "user_id": user_id,
    #         "no_cache": no_cache
    #     }, params=self.protocol_params)
    ...
    #     result = await HttpUtil.http_post(f"{self.baseurl_http}/get_group_member_list", {
    #         "group_id": group_id
    #     }, params=self.protocol_params)
    #     if result["status"] == "ok":
    ...
    #     result = await HttpUtil.http_post(f"{self.baseurl_http}/get_group_honor_info", {
    #         "group_id": group_id,
    #         "type": type
    #     }, params=self.protocol_params)
    #     if result["status"] == "ok":
    ...
    #     result = await HttpUtil.http_post(f"{self.baseurl_http}/can_send_image")
    #     if result["status"] == "ok":
    #         if result["data"]["yes"]:
    #             return True
    #     return False
    ...
    #     result = await HttpUtil.http_post(f"{self.baseurl_http}/can_send_record")
    #     if result["status"] == "ok":
    #         if result["data"]["yes"]:
    #             return True
    #     return False
    ...
    #     result = await HttpUtil.http_post(f"{self.baseurl_http}/get_version_info")
    #     if result["status"] == "ok":
    #         return AppVersion.parse_obj(result["data"])
    #     return False
    #
    # async def restartAPI(self, delay: int = 0) -> bool:
    #     result = await HttpUtil.http_post(f"{self.baseurl_http}/set_restart", {
    #         "delay": delay
    #     }, params=self.protocol_params)
    #     if result["status"] == "ok":
    #         return True
    ...
    #     result = await HttpUtil.http_post(f"{self.baseurl_http}/ocr_image", {
    #         "image": image
    #     }, params=self.protocol_params)
    #     if result["status"] == "ok":
    ...
    #     result = await HttpUtil.http_post(f"{self.baseurl_http}/get_group_system_msg")
    #     if result["status"] == "ok":
    #         return GroupSystemMessage.parse_obj(result["data"])
    #     return False
    #
    # async def uploadGroupFile(self, group_id: int) -> T.Union[GroupFileSystem, bool]:
    #     result = await HttpUtil.http_post(f"{self.baseurl_http}/get_group_file_system_info", {
    #         "group_id": group_id
    #     }, params=self.protocol_params)
    #     if result["status"] == "ok":
    ...
    #     result = await HttpUtil.http_post(f"{self.baseurl_http}/get_group_root_files", {
    #         "group_id": group_id
    #     }, params=self.protocol_params)
    #     if result["status"] == "ok":
    ...
    #     result = await HttpUtil.http_post(f"{self.baseurl_http}/get_group_file_url", {
    #         "group_id": group_id,
    #         "file_id": file_id,
    #         "busid": busid
    #     }, params=self.protocol_params)
    ...
    #     result = await HttpUtil.http_post(f"{self.baseurl_http}/get_status")
    #     if result["status"] == "ok":
    #         return AppStatus.parse_obj(result["data"])
    #     return False
    #
    # async def getGroupAtAllRemain(self, group_id: int) -> T.Union[AtAllRemain, bool]:
    #     result = await HttpUtil.http_post(f"{self.baseurl_http}/get_group_at_all_remain", {
    #         "group_id": group_id
    #     }, params=self.protocol_params)
    #     if result["status"] == "ok":
    ...
    #     result = await HttpUtil.http_post(f"{self.baseurl_http}/_get_vip_info", {
    #         "user_id": user_id
    #     }, params=self.protocol_params)
    #     if result["status"] == "ok":
    ...
    #     result = await HttpUtil.http_post(f"{self.baseurl_http}/_send_group_notice", {
    #         "group_id": group_id,
    #         "content": content
    #     }, params=self.protocol_params)
    #     if result["status"] == "ok":
    ...
    #     result = await HttpUtil.http_post(f"{self.baseurl_http}/reload_event_filter", {
    #         "file": file
    #     }, params=self.protocol_params)
    #     if result["status"] == "ok":
    #         return True
    ...
    #     result = await HttpUtil.http_post(f"{self.baseurl_http}/download_file", {
    #         "url": url,
    #         "headers": headers,
    ...
    #     result = await HttpUtil.http_post(f"{self.baseurl_http}/get_online_clients", {
    #         "no_cache": no_cashe
    #     }, params=self.protocol_params)
    #     if result["status"] == "ok":
    ...
    #     return False
    #
    # async def getGroupMessageHistory(self, group_id: int, message_seq: Optional[int] = None) -> T.Union[
    #     List[Message], bool]:
    #     result = await HttpUtil.http_post(f"{self.baseurl_http}/get_group_msg_history", {
    ...
    #     result = await HttpUtil.http_post(f"{self.baseurl_http}/set_essence_msg", {
    #         "message_id": message_id
    ...
    #     result = await HttpUtil.http_post(f"{self.baseurl_http}/delete_essence_msg", {
    #         "message_id": message_id
    ...
    #     result = await HttpUtil.http_post(f"{self.baseurl_http}/get_essence_msg_list", {
    #         "group_id": group_id
    #     }, params=self.protocol_params)
    #     if result["status"] == "ok":
    ...
    #     result = await HttpUtil.http_post(f"{self.baseurl_http}/check_url_safely", {
    #         "url": url
    #     }, params=self.protocol_params)
    #     if result["status"] == "ok":
    #         return result["level"]
    ...
    #     result = await HttpUtil.http_post(f"{self.baseurl_http}/_get_model_show", {
    #         "model": model
    #     }, params=self.protocol_params)
    #     if result["status"] == "ok":
    ...
    #     result = await HttpUtil.http_post(f"{self.baseurl_http}/_set_model_show", {
    #         "model": model,
    ...
    #     获取频道系统内BOT的资料
    #     '''
    #     result = await HttpUtil.http_post(f"{self.baseurl_http}/get_guild_service_profile")
    #     if result["status"] == "ok":
    ...
    #     获取频道列表
    #     '''
    #     result = await HttpUtil.http_post(f"{self.baseurl_http}/get_guild_list")
    #     if result["status"] == "ok":
    ...
    #     通过访客获取频道元数据
    #     '''
    #     result = await HttpUtil.http_post(f"{self.baseurl_http}/get_guild_meta_by_guest", {
    #         "guild_id": guild_id
    #     }, params=self.protocol_params)
    #     if result["status"] == "ok":
    ...
    #     获取子频道列表
    #     '''
    #     result = await HttpUtil.http_post(f"{self.baseurl_http}/get_guild_channel_list", {
    #         "guild_id": guild_id,
    #         "no_cache": no_cache
    #     }, params=self.protocol_params)
    #     if result["status"] == "ok":
    ...
    #     获取频道成员列表
    #     '''
    #     result = await HttpUtil.http_post(f"{self.baseurl_http}/get_guild_members", {
    #         "guild_id": guild_id
    #     }, params=self.protocol_params)
    #     if result["status"] == "ok":
    ...
    #     return False
    #
    # async def sendGuildChannelMessage(self, guild_id: int, channel_id: int, message: T.Union[str, list]) -> T.Union[
    #     BotMessage, bool]:
    #     '''
    #     发送信息到子频道
    #     '''
    ...
    #         message = _message
    #     result = await HttpUtil.http_post(f"{self.baseurl_http}/send_guild_channel_msg", {
    #         "guild_id": guild_id,
    ...
    #     获取频道身份组列表
    #     '''
    #     result = await HttpUtil.http_post(f"{self.baseurl_http}/get_guild_roles", {
    #         "guild_id": guild_id
    #     }, params=self.protocol_params)
    #     if result["status"] == "ok":
    ...
    #     return False
    #
    # async def createGuildRole(self, guild_id: int, name: str, color: int, independent: bool,
    #                           initial_users: T.List[int] = []) -> T.Union[Role, bool]:
    #     '''
    #     创建频道身份组
    #     '''
    #     result = await HttpUtil.http_post(f"{self.baseurl_http}/create_guild_role", {
    #         "guild_id": guild_id,
    #         "name": name,
    #         "color": color,
    ...
    #     删除频道身份组
    #     '''
    #     result = await HttpUtil.http_post(f"{self.baseurl_http}/delete_guild_role", {
    #         "guild_id": guild_id,
    #         "role_id": role_id
    #     }, params=self.protocol_params)
    #     if result["status"] == "ok":
    ...
    #     设置用户在频道中的身份组
    #     '''
    #     result = await HttpUtil.http_post(f"{self.baseurl_http}/set_guild_member_role", {
    #         "guild_id": guild_id,
    #         "role_id": role_id,
    #         "users": users
    #     }, params=self.protocol_params)
    ...
    #     设置用户在频道中的身份组
    #     '''
    #     result = await HttpUtil.http_post(f"{self.baseurl_http}/update_guild_role", {
    #         "guild_id": guild_id,
    #         "role_id": role_id,
    #         "name": name,
    #         "color": color,
    ...
    #     获取论坛子频道帖子列表
    #     '''
    #     result = await HttpUtil.http_post(f"{self.baseurl_http}/get_topic_channel_feeds", {
    #         "guild_id": guild_id,
    #         "channel_id": channel_id
    #     }, params=self.protocol_params)
    #     if result["status"] == "ok":
